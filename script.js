...
if (heroSubtitle) {
    ...
    heroSubtitle.style.borderRight = '2px solid #6366f1';
...
document.querySelectorAll('.project-card, .skill-tag, .stat-card, .contact-card, .timeline-content').forEach(element => {
